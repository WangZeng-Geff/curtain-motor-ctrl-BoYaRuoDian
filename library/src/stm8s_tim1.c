...
/**
  ...
  * None
  */
void TIM1_TimeBaseInit(unsigned short TIM1_Prescaler,
...
/**
  ...
  */
#if 0
void _TIM1_OC1Init(u16 TIM1_Pulse)
{
...
/**
  ...
  */
#if 0
void _TIM1_OC2Init( u16 TIM1_Pulse)
{
    /* Check the parameters */
    assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
    assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
/**
  ...
  */
#if 0
void _TIM1_OC3Init(u16 TIM1_Pulse)
{
...
/**
  ...
  */
#if 0
void _TIM1_OC4Init(u16 TIM1_Pulse)
{
...
#endif
  if (TIM1_Channel == TIM1_CHANNEL_3)
  {
    /* TI3 Configuration */
  ...
  ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
{
    ...
    if(!(TIM1->SR1 & (u8)TIM1_IT)) return(RESET);

    if(!(TIM1->IER & (u8)TIM1_IT)) return(RESET);
    return(SET);
#else  
...
void TI3_Config(void)
{
    ...
    /* Select the Input and set the filter */
    TIM1->CCMR3 = (u8)(( (TIM1_ICSELECTION_DIRECTTI)) | ((u8)( 0x0F << 4)));
...
void TI4_Config(void)
{
    ...
    /* Select the Input and set the filter */
    TIM1->CCMR4 = (u8)(( (TIM1_ICSELECTION_DIRECTTI)) | ((u8)( 0x0F << 4)));
