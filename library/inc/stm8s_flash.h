...
#define FLASH_PROG_START_PHYSICAL_ADDRESS ((u32)0x008000) /*!< Program memory: start address */
 ...
 #define FLASH_BLOCK_SIZE                  ((u16)128)       /*!< Number of bytes in a block (common for Program and Data memories) */
 ...
 #define FLASH_BLOCK_SIZE                  ((u32)128)       /*!< Number of bytes in a block (common for Program and Data memories) */
#endif /* STM8S105 */
...
void FLASH_ProgramByte(u16 Address, u8 Data);
u8 FLASH_ReadByte(u16 Address);
