...
#else
#define  TIM1_OC1Init(TIM1_Pulse)   _TIM1_OC1Init( TIM1_Pulse)
#define  TIM1_OC2Init(TIM1_Pulse)   _TIM1_OC2Init( TIM1_Pulse)
#define  TIM1_OC3Init(TIM1_Pulse)   _TIM1_OC3Init( TIM1_Pulse)
#define  TIM1_OC4Init(TIM1_Pulse)   _TIM1_OC4Init( TIM1_Pulse)
#define TIM1_TimeBaseInit( TIM1_Prescaler,  TIM1_CounterMode,  TIM1_Period,  TIM1_RepetitionCounter)   _TIM1_TimeBaseInit()
...
#define TIM1_ClearFlag( TIM1_FLAG)  do{TIM1->SR1 = (u8)(~(u8)(TIM1_FLAG));}while(0)
